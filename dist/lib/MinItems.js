...
var MinItems = (function (_ArrayKeyword) {
  _inherits(MinItems, _ArrayKeyword);

  function MinItems(value) {
    _classCallCheck(this, MinItems);

    _get(Object.getPrototypeOf(MinItems.prototype), 'constructor', this).call(this);
    this.value = value;
  }

  _createClass(MinItems, [{
    key: 'json',
